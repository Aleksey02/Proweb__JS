...
function logic() {
    ...
    let btnPlusOrMinus = document.querySelectorAll('.main__product-btn'),
        ...
        doubleClick = document.querySelectorAll('.main__product-info');
        ClouseClick = document.querySelector('.view__close')
    ...
    doubleClick.forEach(img => {
        img.addEventListener('dblclick', function(){
        let image = document.querySelector('.view img')
        let Id = img.closest('.main__product').getAttribute('id')
        image.setAttribute('src', product[Id].img)
        let view = document.querySelector('.view');
        view.classList.add('active');
        })
    })

    ClouseClick.addEventListener('click',function(){
        let view = document.querySelector('.view');
